...
const NewsCard = ({
    ...
    // Name der Quelle ermitteln (entweder aus dem Objekt oder aus der URL)
    ...
    return (
        <article 
            ...
            <div className="relative aspect-[16/9] w-full overflow-hidden">
                ...
                {/* Quellen-Badge (oben links im Bild) */}
                ...
                {/* Dunkler Verlauf am unteren Bildrand für bessere Lesbarkeit */}
